...
let s:cpo_save=&cpo
set cpo&vim
inoremap <ScrollWheelDown> <ScrollWheelDown><Cmd>ScrollViewRefresh
inoremap <ScrollWheelUp> <ScrollWheelUp><Cmd>ScrollViewRefresh
...
imap <silent> <LeftMouse> <Plug>(ScrollViewLeftMouse)
inoremap <silent> <Plug>(ScrollViewX2Mouse) <Cmd>lua require("scrollview").handle_mouse("x2")
inoremap <silent> <Plug>(ScrollViewX1Mouse) <Cmd>lua require("scrollview").handle_mouse("x1")
inoremap <silent> <Plug>(ScrollViewRightMouse) <Cmd>lua require("scrollview").handle_mouse("right")
inoremap <silent> <Plug>(ScrollViewMiddleMouse) <Cmd>lua require("scrollview").handle_mouse("middle")
inoremap <silent> <Plug>(ScrollViewLeftMouse) <Cmd>lua require("scrollview").handle_mouse("left")
...
vnoremap R R<Cmd>ScrollViewRefresh
nnoremap R R<Cmd>ScrollViewRefresh
vnoremap  <Cmd>ScrollViewRefresh
nnoremap  <Cmd>ScrollViewRefresh
vnoremap r r<Cmd>ScrollViewRefresh
nnoremap r r<Cmd>ScrollViewRefresh
vnoremap L L<Cmd>ScrollViewRefresh
nnoremap L L<Cmd>ScrollViewRefresh
vnoremap K K<Cmd>ScrollViewRefresh
nnoremap K K<Cmd>ScrollViewRefresh
vnoremap J J<Cmd>ScrollViewRefresh
nnoremap J J<Cmd>ScrollViewRefresh
vnoremap H H<Cmd>ScrollViewRefresh
nnoremap H H<Cmd>ScrollViewRefresh
nnoremap  fs <Cmd>Telescope session-lens search_session
...
nmap  sl :SessionLoad
nmap  ss :SessionSave
nnoremap  fh <Cmd>Telescope oldfiles
nnoremap  fc <Cmd>Telescope command_history
nnoremap  fd <Cmd>Telescope
nnoremap  f? <Cmd>Telescope help_tags
nnoremap  fb <Cmd>Telescope buffers
nnoremap  fr <Cmd>Telescope live_grep
nnoremap  ff <Cmd>Telescope find_files
nmap  b :silent! bd
vnoremap <silent>   :silent  :silent WhichKeyVisual ' '
...
nmap  ms :marks
nnoremap <silent>   :silent  :silent WhichKey ' '
...
vnoremap jk 
vnoremap kj 
vnoremap zi zi<Cmd>ScrollViewRefresh
nnoremap zi zi<Cmd>ScrollViewRefresh
vnoremap zN zN<Cmd>ScrollViewRefresh
nnoremap zN zN<Cmd>ScrollViewRefresh
vnoremap zn zn<Cmd>ScrollViewRefresh
nnoremap zn zn<Cmd>ScrollViewRefresh
vnoremap zR zR<Cmd>ScrollViewRefresh
nnoremap zR zR<Cmd>ScrollViewRefresh
vnoremap zr zr<Cmd>ScrollViewRefresh
nnoremap zr zr<Cmd>ScrollViewRefresh
vnoremap zM zM<Cmd>ScrollViewRefresh
nnoremap zM zM<Cmd>ScrollViewRefresh
vnoremap zm zm<Cmd>ScrollViewRefresh
nnoremap zm zm<Cmd>ScrollViewRefresh
vnoremap zX zX<Cmd>ScrollViewRefresh
nnoremap zX zX<Cmd>ScrollViewRefresh
vnoremap zx zx<Cmd>ScrollViewRefresh
nnoremap zx zx<Cmd>ScrollViewRefresh
vnoremap zv zv<Cmd>ScrollViewRefresh
nnoremap zv zv<Cmd>ScrollViewRefresh
vnoremap zA zA<Cmd>ScrollViewRefresh
nnoremap zA zA<Cmd>ScrollViewRefresh
vnoremap za za<Cmd>ScrollViewRefresh
nnoremap za za<Cmd>ScrollViewRefresh
vnoremap zC zC<Cmd>ScrollViewRefresh
nnoremap zC zC<Cmd>ScrollViewRefresh
vnoremap zc zc<Cmd>ScrollViewRefresh
nnoremap zc zc<Cmd>ScrollViewRefresh
vnoremap zO zO<Cmd>ScrollViewRefresh
nnoremap zO zO<Cmd>ScrollViewRefresh
vnoremap zo zo<Cmd>ScrollViewRefresh
nnoremap zo zo<Cmd>ScrollViewRefresh
vnoremap zE zE<Cmd>ScrollViewRefresh
nnoremap zE zE<Cmd>ScrollViewRefresh
vnoremap zD zD<Cmd>ScrollViewRefresh
nnoremap zD zD<Cmd>ScrollViewRefresh
vnoremap zd zd<Cmd>ScrollViewRefresh
nnoremap zd zd<Cmd>ScrollViewRefresh
vnoremap zF zF<Cmd>ScrollViewRefresh
nnoremap zF zF<Cmd>ScrollViewRefresh
vnoremap zf zf<Cmd>ScrollViewRefresh
...
tnoremap <ScrollWheelDown> <ScrollWheelDown><Cmd>ScrollViewRefresh
vnoremap <ScrollWheelDown> <ScrollWheelDown><Cmd>ScrollViewRefresh
nnoremap <ScrollWheelDown> <ScrollWheelDown><Cmd>ScrollViewRefresh
tnoremap <ScrollWheelUp> <ScrollWheelUp><Cmd>ScrollViewRefresh
vnoremap <ScrollWheelUp> <ScrollWheelUp><Cmd>ScrollViewRefresh
nnoremap <ScrollWheelUp> <ScrollWheelUp><Cmd>ScrollViewRefresh
...
vmap <silent> <LeftMouse> <Plug>(ScrollViewLeftMouse)
nmap <silent> <LeftMouse> <Plug>(ScrollViewLeftMouse)
noremap <silent> <Plug>(ScrollViewX2Mouse) <Cmd>lua require("scrollview").handle_mouse("x2")
noremap <silent> <Plug>(ScrollViewX1Mouse) <Cmd>lua require("scrollview").handle_mouse("x1")
noremap <silent> <Plug>(ScrollViewRightMouse) <Cmd>lua require("scrollview").handle_mouse("right")
noremap <silent> <Plug>(ScrollViewMiddleMouse) <Cmd>lua require("scrollview").handle_mouse("middle")
noremap <silent> <Plug>(ScrollViewLeftMouse) <Cmd>lua require("scrollview").handle_mouse("left")
...
tnoremap <silent> <F12> :FloatermKill
nnoremap <silent> <F12> :FloatermKill
...
set mouse=a
set pumheight=10
set runtimepath=~/.config/nvim,~/.vim/plugged/onedark.vim,~/.vim/plugged/auto-session,~/.vim/plugged/session-lens,~/.vim/plugged/nvim-web-devicons,~/.vim/plugged/bufferline.nvim,~/.vim/plugged/nvim-cursorline,~/.vim/plugged/indent-blankline.nvim,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/ripgrep,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-devicons,~/.vim/plugged/nerdcommenter,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-which-key,~/.vim/plugged/rnvimr,~/.vim/plugged/vim-easymotion,~/.vim/plugged/vim-polyglot,~/.vim/plugged/vim-floaterm,~/.vim/plugged/nvim-neoclip.lua,~/.vim/plugged/plenary.nvim,~/.vim/plugged/telescope.nvim,~/.vim/plugged/nvim-treesitter,~/.vim/plugged/dashboard-nvim,~/.vim/plugged/coc.nvim,~/.vim/plugged/nvim-scrollview,~/.config/nvim/pack/kite/start/vim-plugin,~/.config/nvim/pack/airblade/start/vim-gitgutter,/etc/xdg/xdg-i3/nvim,/etc/xdg/xdg-ubuntu/nvim,/etc/xdg/nvim,~/.local/share/nvim/site,/usr/share/i3/nvim/site,/usr/share/ubuntu/nvim/site,/usr/local/share/nvim/site,/usr/share/nvim/site,/var/lib/snapd/desktop/nvim/site,/tmp/.mount_nvimfh55eK/usr/share/nvim/runtime,/tmp/.mount_nvimfh55eK/usr/share/nvim/runtime/pack/dist/opt/matchit,/tmp/.mount_nvimfh55eK/usr/lib/nvim,/var/lib/snapd/desktop/nvim/site/after,/usr/share/nvim/site/after,/usr/local/share/nvim/site/after,/usr/share/ubuntu/nvim/site/after,/usr/share/i3/nvim/site/after,~/.local/share/nvim/site/after,/etc/xdg/nvim/after,/etc/xdg/xdg-ubuntu/nvim/after,/etc/xdg/xdg-i3/nvim/after,~/.vim/plugged/vim-polyglot/after,~/.vim/plugged/nvim-treesitter/after,~/.config/nvim/after
set scrolloff=1000
set sessionoptions=blank,buffers,curdir,folds,help,tabpages,winsize,resize,winpos,terminal,options,resize,winpos,terminal
set shiftwidth=4
...
set splitbelow
set splitright
set statusline=%{coc#status()}%{get(b:,'coc_current_function','')}%{coc#status()}%{get(b:,'coc_current_function','')}%{coc#status()}%{get(b:,'coc_current_function','')}
...
set shortmess=aoO
badd +123 .config/nvim/init.vim
badd +8 .config/nvim/plug-config/telescope.vim
badd +1 .config/nvim/vim-plug/plugins.vim
argglobal
%argdel
set lines=55 columns=189
edit .config/nvim/init.vim
argglobal
balt .config/nvim/plug-config/telescope.vim
let s:cpo_save=&cpo
set cpo&vim
...
nnoremap <buffer> <silent> gnn :lua require'nvim-treesitter.incremental_selection'.init_selection()
...
silent! normal! zE
let &fdl = &fdl
let s:l = 122 - ((35 * winheight(0) + 26) / 52)
